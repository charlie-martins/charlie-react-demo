  ...
  return (
    <Card className="space-y-4">
      ...
      <section className="space-y-2">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          <Button label="Add" primary icon={<PlusIcon />} iconPosition="left" />
          <Button label="New" soft icon={<PlusIcon />} iconPosition="left" />
          <Button label="Edit" ghost icon={<PlusIcon />} iconPosition="left" />
          <Button
            label="Filter"
            outline
            icon={<PlusIcon />}
      ...
      <section className="space-y-2">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <Button ghost icon={<PlusIcon />} iconOnly aria-label="Add (ghost)" />
          <Button
            outline
            icon={<PlusIcon />}
            iconOnly
